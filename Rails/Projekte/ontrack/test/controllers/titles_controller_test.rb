...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { description: @title.description, start_date: @title.start_date } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { description: @title.description, start_date: @title.start_date } }
